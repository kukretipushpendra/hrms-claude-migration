 ...
 * 
 * Security:
 * - Requires ReadEmployees permission for access
...
using HRMS.API.Athorization;          // Custom authorization attributes
using HRMS.API.Validations;           // Request validation
using HRMS.Application.Services.Interfaces;  // Service interfaces
using HRMS.Domain.Contants;           // Application constants
using HRMS.Models;                    // Data models
using HRMS.Models.Models.Employees;    // Employee-specific models
using HRMS.Models.Models.UserProfile;  // User profile models
