...
description: Node.js/Express specialist for scalable TypeScript backend applications. Invoke for routes, controllers, services, middleware, mssql database. Keywords: Node.js, Express, TypeScript backend, REST API.
triggers:
  - Node.js
  - Express
  - TypeScript backend
